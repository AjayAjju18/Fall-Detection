...
class FallDetector:
    def __init__(self):
        ...
        self.max_history = 10
        self.fall_threshold_velocity = -2.0
        self.fall_threshold_acceleration = -15.0
        self.ground_proximity_threshold = 0.3
        ...
        try:
            ...
            if len(self.position_history) >= 3:
                ...
                if len(self.velocity_history) >= 2:
                    ...
                    horizontal_orientation = head_to_hip_distance < 0.3
